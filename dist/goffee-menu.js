...
(function () {
  ...
  var CONFIG = {
    ...
    logoSrc: "goffee-logo.png",      // su Webflow: incolla l'URL dell'asset caricato
  ...
  // esposto per eventuale personalizzazione da Webflow prima del mount
  window.GoffeeMenu = { config: CONFIG, render: function () { if (root) render(); } };
})();
