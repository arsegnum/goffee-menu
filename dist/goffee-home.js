...
(function () {
  ...
  function navbar() {
    return '' +
      ...
      '<a class="btn" href="' + telHref() + '">Ordina ora</a>' +
      '</div>' +
      '<div class="gnav__actions">' +
      '<a class="btn" href="' + telHref() + '">' + ICON.phone.replace(/\{S\}/g, 17) + ' Ordina ora</a>' +
  ...
  function hero() {
    return '' +
      ...
      '<div class="hero__cta">' +
      '<a class="btn btn--lg" href="' + telHref() + '">' + ICON.phone.replace(/\{S\}/g, 18) + ' Ordina ora — ' + esc(CONFIG.tel) + '</a>' +
  ...
  function footer() {
    return '' +
      ...
      '</div>' +
      '<div class="foot-cta">' +
      '<a class="btn btn--lg" href="' + telHref() + '">' + ICON.phone.replace(/\{S\}/g, 18) + ' Chiama per ordinare</a>' +
